...
const loginDoctor=async(req,res)=>{
  try {
    ...
    if(isMatch){
      ...
      res.jon({success:false,message:"Invalid credentials"})
    }
...
//API to mark doctor appointment completed for doctor panel
...
//API to cancel doctor appointment completed for doctor panel
